...
public class FileUtil {
    ...
    public static String createFile(String dir_name, String file_name) {
        ...
        String dir_path = String.format("/data/user/0/com.example.inprint/files/%s", dir_name);
        ...
        try {
            ...
            if(!myFile.createNewFile()) {
                LogUtil.d("FileUtil","File already exists");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static byte[] getPictureBytes(ZipFile docxFile, ZipEntry pic_entry) {
        ...
        try {
            ...
            LogUtil.d(TAG, "pictureBytes.length=" + pictureBytes.length);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return pictureBytes;
